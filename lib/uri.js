 ...
 * @returns {URI} A new valid and fro flux instance of URI
 * @constructor
 */
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'zelcash:' || info.protocol !== 'flux:' || info.protocol !== 'zel:') {
    throw new TypeError('Invalid flux URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid flux address');
  }
